<!--
**ysfgouicem/ysfgouicem** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
<p align="left">👋 Hi! I’m Youssef, a Data Engineer with 5+ years of experience designing and automating data pipelines to make complex systems simple, efficient, and scalable.<br><br>🚧 Beyond work — my side projects:<br>My personal projects blend data engineering with AI experimentation:<br>• I prototype end-to-end pipelines — from data ingestion and transformation to model deployment.<br>• I explore AI applications in real-time analytics, anomaly detection, and visual recognition.<br><br>🎓 Currently leveling up with certifications on public cloud platforms (AWS) to deepen my expertise in cloud-native architectures and prep for my next step:<br>📈 Becoming a Data Architect — someone who not only builds but designs the full data ecosystem.<br><br>❤️ Some things I love :<br>Traveling 🌎 Pretty charts 📊 pizza 🍕</p>
Please feel free to reach out to me via my LinkedIn profile.
<p>
<a href="https://www.linkedin.com/in/youssef-gouicem-lakhal/">
